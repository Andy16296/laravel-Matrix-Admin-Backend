              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    <a href="{{ url('/admin/add_attributes/'.$product->id) }}" class="btn btn-success btn-mini">Add</a> 
                    <a rel="{{ $product->id }}" rel1="delete_product" <?php /* href="{{ url('/admin/delete_product/'.$product->id) }}" */?> href="javascript:" class="btn btn-danger btn-mini deleteRecord">Delete</a></td>
                </tr>
