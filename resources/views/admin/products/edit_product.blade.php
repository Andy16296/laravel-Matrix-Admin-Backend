            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('admin/edit_product/'.$productDetails->id) }}" name="edit_product" id="edit_product" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  <img style="width:40px;" src="{{ asset('/images/backend_images/products/small/'.$productDetails->image) }}"> | <a href="{{ url('/admin/delete_product_image/'.$productDetails->id) }}">Delete Product Picture</a>
                  @endif
                </div>  
              </div>
              <div class="control-group">
