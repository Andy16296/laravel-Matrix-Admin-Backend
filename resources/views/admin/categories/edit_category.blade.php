      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit_category/'.$categoryDetails->id) }}" name="edit_category" id="edit_category" novalidate="novalidate"> {{ csrf_field() }}
              ...
              <div class="form-actions">
                <input type="submit" value="Edit Category andy" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
